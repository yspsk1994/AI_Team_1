...
def handle_user_input(user_input, chat_history):
    guide_prompt = '''
    도서관에 관련된 정보이면 도서 정보 소개해줘
    도서(책)에 관한 제목,저자,출판사,장르,청구기호,중에 부분을 쳐도 소개해줘
    영화, 음악, 쇼핑, 여행, 연예인, 게임, 음식 등 도서관과 무관한 질문은 무시해도 되는데.
    '''
    ...
    # 도서 검색 시도
    matched_books = search_book(user_input)  # 전체 사용자 입력으로 도서 검색
